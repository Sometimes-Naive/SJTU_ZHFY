...
class MsJcjfData:
    ...
    def get_court_info(self):
        ...
        court1 = [('万州区人民法院', 49), ('丰都县人民法院', 44), ('九龙坡区人民法院', 142), ('云阳县人民法院', 18), ('北碚区人民法院', 78), ('南岸区人民法院', 45), ('南川区人民法院', 28), ('合川区人民法院', 87), ('垫江县人民法院', 12), ('城口县人民法院', 20), ('大渡口区人民法院', 32), ('大足区人民法院', 16), ('奉节县人民法院', 24), ('巫山县人民法院', 12), ('巫溪县人民法院', 24), ('巴南区人民法院', 66), ('开州区人民法院', 24), ('彭水苗族土家族自治县人民法院', 19), ('忠县人民法院', 18), ('梁平区人民法院', 101), ('武隆区人民法院', 2), ('永川区人民法院', 8), ('江北区人民法院', 59), ('江津区人民法院', 82), ('沙坪坝区人民法院', 105), ('涪陵区人民法院', 31), ('渝中区人民法院', 63), ('渝北区人民法院', 88), ('潼南区人民法院', 12), ('璧山区人民法院', 25), ('石柱土家族自治县人民法院', 5), ('秀山土家族苗族自治县人民法院', 22), ('第一中级人民法院', 15), ('第三中级人民法院', 14), ('第二中级人民法院', 10), ('第五中级人民法院', 50), ('第四中级人民法院', 9), ('綦江区人民法院', 67), ('荣昌区人民法院', 13), ('酉阳土家族苗族自治县人民法院', 2), ('铜梁区人民法院', 13), ('长寿区人民法院', 28), ('高级人民法院', 22), ('黔江区人民法院', 6)]
        court = {}
        for i in court1:
            m = i[0].replace('区','')
            m = m.replace('人民法院', '')
    ...
    def relation(self):
        ...
        for i in JCJF.objects(Q(案由='继承纠纷')):
            a = i.庭审过程
            if '父' in a or '母' in a:
                relation['父母子女'] = relation['父母子女'] + 1
            elif '夫' in a or '妻' in a or '婚' in a:
                relation['夫妻'] = relation['夫妻'] + 1
            elif '兄' in a or '弟' in a or '姐' in a or '妹' in a:
                relation['兄弟姐妹'] = relation['兄弟姐妹'] + 1
            else:
                relation['其他'] = relation['其他'] + 1
        return relation
    ...
    def verdict(self):
        ...
        for i in JCJF.objects(Q(案由='继承纠纷')):
            a = i.庭审过程
            if '房屋' in a:
                verdict['房屋'] = verdict['房屋'] + 1
            elif '公司' in a:
                verdict['公司'] = verdict['公司'] + 1
            elif '遗产' in a or '钱' in a or '遗嘱' in a:
                verdict['遗产'] = verdict['遗产'] + 1
            elif '债' in a:
                verdict['债务'] = verdict['债务'] + 1
            else:
                verdict['其他'] = verdict['其他'] + 1
        return verdict

relation_result = {'父母子女': 675, '夫妻': 107, '兄弟姐妹': 91, '其他': 68}
verdict_result = {'房屋': 579, '公司': 76, '遗产': 108, '债务': 21, '其他': 27}
...
PLAAGE = {'20岁以下': 30, '20~30岁': 96, '31~40岁': 136, '41~50岁': 283, '51~60岁': 318, '61~70岁': 304, '70岁以上': 280}
PLAAGE_FEMALE = {'20岁以下': 18, '20~30岁': 40, '31~40岁': 66, '41~50岁': 127, '51~60岁': 157, '61~70岁': 160, '70岁以上': 175}
PLAAGE_MALE = {'20岁以下': 12, '20~30岁': 56, '31~40岁': 70, '41~50岁': 156, '51~60岁': 161, '61~70岁': 144, '70岁以上': 105}
DEFAGE = {'20岁以下': 13, '20~30岁': 75, '31~40岁': 153, '41~50岁': 310, '51~60岁': 297, '61~70岁': 368, '70岁以上': 223}
DEFAGE_MALE = {'20岁以下': 6, '20~30岁': 35, '31~40岁': 66, '41~50岁': 172, '51~60岁': 140, '61~70岁': 203, '70岁以上': 92}
DEFAGE_FEMALE = {'20岁以下': 6, '20~30岁': 40, '31~40岁': 88, '41~50岁': 138, '51~60岁': 154, '61~70岁': 164, '70岁以上': 130}
plaintiff_sex = {'男': 751, '女': 776}
defendant_sex = {'男': 748, '女': 770}
aj_male = [plaintiff_sex['男'],defendant_sex['男']]
aj_female = [plaintiff_sex['女'],defendant_sex['女']]
case_date_number = {'2017': 322, '2018': 1013, '2019': 260}
...
class OverviewInfo:
    ...
    def get_overview_data(self):
        ...
        jdjf_ajnumber = 1611#LHJF.objects.count()  #
...
class ChartData:
    ...
    def get_person_info(self):
        ...
        his_job_data = [['无业游民', '工人', '自营业主', '教师', '医生', '农民'], [220, 130, 340, 10, 15, 750]]
...
class case_analysis:
    ...
    def special_case_analysis(self):
        ...
        pie_relation_data = {
            'name': '原被告关系',
            'data': case_analysis().get_pie_data(relation_result)
        }
        pie_verdict_data = {
            'name': '涉诉物品',
            'data': case_analysis().get_pie_data(verdict_result)
        }
        analysis['pie_relation_data']=pie_relation_data
        analysis['pie_verdict_data']=pie_verdict_data
        return analysis
analysis_jcjf=case_analysis().special_case_analysis
